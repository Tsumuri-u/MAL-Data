...
def main():
    ...
    plot_parser.add_argument("target", choices=["test", "scoretime", "scoreisekai", "histogramisekai"])
    ...
    if args.command == "scrape":
        ...
        elif args.target == "histogramisekai":
            plotter.isekai_double_gaussian(anime_data)
